...
module audio_equalizer_tb ();
  localparam FILE_PATH = "C:/altera/projects/FPGA/AUDIO_EQUALIZER/samples/audio2.hex";
  localparam OUT_PATH  = "C:/altera/projects/FPGA/AUDIO_EQUALIZER/samples/output_audio2.hex";
