...
module IIR_tb ();
  localparam FILE_PATH = "C:/altera/projects/FPGA/IIR_filter/samples/ecg.hex";
  localparam OUT_PATH  = "C:/altera/projects/FPGA/IIR_filter/output_samples/output_ecg.hex";
