...
module IIR #(
    ...
    parameter [(ORDER+1)*COEFF_W-1:0] COEFF_A = {32'd1048576, -32'd4022154, 32'd5788998, -32'd3705180, 32'd889775},
    parameter [(ORDER+1)*COEFF_W-1:0]  COEFF_B = {32'd0, 32'd3, 32'd5, 32'd3, 32'd0}
)(
    input logic clk,
    input logic reset_n,
